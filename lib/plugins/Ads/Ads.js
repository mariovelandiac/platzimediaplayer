...
]; // lista de Ads (Videos que salen debajito del media Player)
var Ads = /** @class */ (function () {
    ...
    Ads.prototype.initAds = function () {
        this.ads = __spreadArray([], ALL_ADS, true); //Añadiendo el spread operator estamos dejando caer toda la información de ALL_ADS sobre un nuevo Array
    };
    Ads.prototype.getAds = function () {
        if (this.ads.length === 0) {
            this.initAds();
        }
        return this.ads.pop(); // método pop elimina el ultimo elemento de un array y lo retorna
    };
    return Ads;
}());
exports["default"] = Ads;
